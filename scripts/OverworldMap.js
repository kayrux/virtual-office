...
window.OverworldMaps = {
  Hallway: {
    lowerSrc: "assets/maps/Hallway.png",
    upperSrc: "",
    gameObjects: {
      hero: new Person({
  ...
  "Meeting Room": {
    lowerSrc: "assets/maps/MeetingRoom.png",
    upperSrc: "",
    gameObjects: {
      hero: new Person({
        isPlayerControlled: true,
  ...
  "Break Room": {
    lowerSrc: "assets/maps/BreakRoom.png",
    upperSrc: "",
    gameObjects: {
      hero: new Person({
        isPlayerControlled: true,
  ...
  Blank: {
    lowerSrc: "assets/maps/Blank.png",
    upperSrc: "",
    gameObjects: {
      hero: new Person({
        isPlayerControlled: true,
...
//       y: utils.withGrid(5),
//       name: "Harry",
//       src: "assets/characters/people/officeguy.png",
//       // behaviorLoop: [
//       //   { type: "walk",  direction: "left" },
//       //   { type: "stand",  direction: "up", time: 800 },
//       //   { type: "walk",  direction: "up" },
