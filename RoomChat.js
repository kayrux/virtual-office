...
document.getElementById('sendRoomChatButton').addEventListener('click', sendRoomChatMessage);

document.getElementById('roomChatMessage').addEventListener('keypress', function (e) {
    if (e.key === 'Enter') {
